...
Fig.1 - Six base points, four corner and two helping midpoints, for creation of the CFD domain geometry.

Now connect these six points to each other and create a united surface to form the full geometry of the rectangular pipe as shown in Fig 2.

<img src="./Images/CFD_domain_geometry_surface.png" width="500">
</br>
Fig.2 - Raw geometry of the CFD domain.
...
Fig.4 Generated edge mesh along all of edges of the CFD domain.

At this stage the entire CFD domain can be meshed using surface mesh. This process will connect all predefined mesh element to each other and discretize the CFD domain as visualized in Fig. 5.
